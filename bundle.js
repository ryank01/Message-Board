...
/***/ (function(module, exports, __webpack_require__) {
	...
	function mapDispatchToProps(dispatch) {
		return {
			saveMessge: function saveMessge(message) {
				dispatch((0, _index.sendMessage)(message));
			},
			removeMessge: function removeMessge(message) {
				dispatch((0, _index.deleteMessage)(message));
			}
		};
	};

	var App = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_container2.default);
	exports.default = App;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(_message2.default, { message: this.props })
	          )
	        )
	      );
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Message = function (_Component) {
	  ...
	  function Message() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Message.__proto__ || Object.getPrototypeOf(Message)).call.apply(_ref, [this].concat(args))), _this), _this.state = { msgs: _this.props.message.state }, _temp), _possibleConstructorReturn(_this, _ret);
	  }

	  _createClass(Message, [{
	    key: "remove",
	    value: function remove(msg) {
	    ...
	    value: function render() {
	      ...
	      if (this.state.msgs.length > 0) {
	        var messages = [];
	        this.state.msgs.forEach(function (m) {
	          messages.push(_react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                "p",
	                { style: { color: 'silver', fontFamily: 'Titillium Web' } },
	                date
	              ),
	              _react2.default.createElement(
	                "span",
	                { onClick: _this2.remove.bind(_this2, m), className: "material-icons right" },
	                "delete"
	              )
	            )
	          ));
...
/***/ (function(module, exports) {
	...
	var deleteMessage = exports.deleteMessage = function deleteMessage(message) {
		return {
			type: 'DELETE_MESSAGE',
			payload: message
		};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var myObject = [];
	function reducers() {
		var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : myObject;
		var action = arguments[1];
